...
REPO_LIKE_PATTERN = re.compile(r"(?:^|[-_/])(web|app|api|v\d+|archived)$|example-org|talent-web-app|profile-web-app|candidate-web-app|employee-web-app")
...
CLUSTER_DEFINITIONS: list[dict[str, Any]] = [
    cluster_definition(
        ...
        "Example User's frontend implementation pattern centers on stateful product workflows, not static screens.",
        [
        ...
        "Use this when an agent needs to implement UI behavior for Example User: model the user journey, data state, and validation rules before touching visuals.",
        ...
        ["Example User state management style", "how should Example User build forms", "frontend workflow implementation"],
    ...
    cluster_definition(
        ...
        "Example User tends to treat frontend work as a contract with backend payloads, DTOs, lookups, query parameters, and export schemas.",
        [
        ...
        "Use this when an agent changes payloads, DTOs, lookup values, report filters, or export flows for Example User.",
        ...
        ["Example User API contract style", "data mapping preference", "typed frontend contracts"],
    ...
    cluster_definition(
        ...
        "Example User's frontend coding practice favors componentized, reusable UI construction when product behavior repeats.",
        [
        ...
        ["Example User component practice", "frontend reuse preference", "shared component style"],
    ...
    cluster_definition(
        ...
        "Example User has repeated frontend context around async state, services, streams, effects, and request-driven UI behavior.",
        [
        ...
        ["Example User async frontend style", "RxJS and hooks practice", "service layer state handling"],
    ...
    cluster_definition(
        ...
        "Example User's delivery context shows repeated movement through code review, QA, stage, live, production, and Done handoffs.",
        [
        ...
        "Use this when an agent plans ticket delivery, release steps, or QA-facing communication for Example User.",
    ...
    cluster_definition(
        ...
        "Example User's work history strongly includes bug fixing, regression handling, hotfixes, and reliability-sensitive product corrections.",
        [
        ...
        ["Example User debugging style", "bug reduction evidence", "production reliability behavior"],
    ...
    cluster_definition(
        ...
        "Example User functions as a frontend quality gate through review requests, approvals, review comments, and repository authority signals.",
        [
        ...
        ["Example User PR review style", "frontend quality gate", "review authority"],
    ...
    cluster_definition(
        ...
        "Example User repeatedly works on maintainability, linting, formatting, dependency upgrades, migrations, standards, and cleanup.",
        [
        ...
        "Use this when an agent is choosing between quick code and maintainable code for Example User.",
        ...
        ["Example User maintainability preference", "code standards style", "frontend refactor judgment"],
    ...
    cluster_definition(
        ...
        "Example User has practical AI product and agent-system work across chat, MCP, skills, structured generation, and workflow UI.",
        [
        ...
        "Use this when answering what AI work Example User can contribute to or how an agent should collaborate with him on AI products.",
        ...
        ["Example User AI product work", "agent tooling context", "MCP and skills experience"],
    ...
    cluster_definition(
        ...
        "Example User has recurring contribution to web-app infrastructure, CI/CD workflows, release automation, semantic-release, and deploy plumbing.",
        [
        ...
        "Use this before making release, deploy, build, or workflow changes for Example User.",
        ["Do not infer sole production ownership from workflow evidence alone."],
        ["ci_cd", "delivery", "web_infra", "release", "observability"],
        ["Example User CI/CD experience", "web app infra work", "release automation context"],
    ...
    cluster_definition(
        ...
        "Example User has repeated work around auth, RBAC, permissions, route access, session behavior, and protected frontend states.",
        [
        ...
        ["Example User auth work", "RBAC frontend style", "permission UI context"],
    ...
    cluster_definition(
        ...
        "Example User has product engineering depth in analytics, reporting, dashboards, insights, charts, exports, and correctness of report data.",
        [
        ...
        "Use this when answering about reporting/analytics ability or implementing dashboards and exports for Example User.",
        ...
        ["Example User analytics reporting work", "dashboard export experience", "report correctness context"],
    ...
    cluster_definition(
        ...
        "Example User has long-running product context in recruiting, candidate, role-fit, assessment, job, profile, and hiring workflow systems.",
        [
        ...
        ["Example User recruiting domain knowledge", "candidate workflow context", "role fit assessment experience"],
    ...
    cluster_definition(
        ...
        "Example User has product context in employee learning, goals, courses, action items, learner flows, and workforce development surfaces.",
        [
        ...
        ["Example User employee product context", "learning workflow experience", "goal action item work"],
    ...
    cluster_definition(
        ...
        "Example User has repeated work around translations, language, copywriting, locale handling, and product content workflows.",
        [
        ...
        ["Example User localization work", "translation delivery context", "i18n frontend style"],
    ...
    cluster_definition(
        ...
        "Example User has supporting backend-adjacent work where frontend delivery requires services, serverless functions, repositories, schemas, or API support.",
        [
        ...
        ["Example User backend supporting work", "frontend backend boundary", "serverless support context"],
    ...
    cluster_definition(
        ...
        "Example User's accumulated context points to a preference for correct, maintainable, production-aware solutions over surface-level completion.",
        [
        ...
        "Use this as a default operating preference when choosing implementation approaches for Example User.",
    ...
    cluster_definition(
        ...
        "Example User's comments and workflow history support a coordination style around QA verification, teammate handoff, explanation, and unblocking delivery.",
        [
        ...
        "Use this for drafting work updates, Jira comments, PR replies, or QA handoff notes for Example User.",
    ...
    cluster_definition(
        ...
        "Example User has repository authority signals across review requests, permissions, branch protection, CODEOWNERS, and release-bound repositories.",
        [
        ...
        ["Example User repository authority", "CODEOWNERS proof", "branch protection review responsibility"],
    ...
    cluster_definition(
        ...
        "Example User repeatedly works through migrations, dependency upgrades, lookup changes, framework/package movement, and modernization tasks.",
        [
        ...
        ["Example User migration style", "upgrade execution", "modernization approach"],
    ...
    cluster_definition(
        ...
        "Example User has product engineering context around third-party integrations, service handoffs, and vendor-backed product flows.",
        [
        ...
        ["Example User integration experience", "third party workflow context", "vendor API delivery"],
    ...
    cluster_definition(
        ...
        "Example User has product context in admin consoles, internal tooling, configuration screens, and operational workflows.",
        [
        ...
        ["Example User admin tooling context", "internal tool UI style", "operator workflow experience"],
    ...
    cluster_definition(
        ...
        "Example User's work pattern shows attention to product edge cases such as missing values, wrong values, disabled flows, role-specific visibility, and validation boundaries.",
        [
        ...
        ["Example User edge case review", "frontend product correctness", "validation boundary style"],
    ...
    cluster_definition(
        ...
        "Example User has quality-safety context through tests, lint/format checks, QA workflows, and review-driven correctness.",
        [
        ...
        "Use this when choosing tests, checks, or validation steps for Example User's code changes.",
        ...
        ["Example User testing style", "quality validation preference", "what checks should run"],
    ...
    cluster_definition(
        ...
        "Example User's self-context should answer with distilled knowledge by default and keep raw commits, Jira keys, PR ids, private names, and source traces hidden unless proof is explicitly requested.",
        [
